    ...
    def set_field_data(self, name, data):
        ...
        try:
            ...
            if hasattr(item,"value"):
                ...
                print "not found item's value field"
                raise Exception
        except:
            print self.names
...
class size:
    ...
    def __init__ (self, block_name, request, offset=0 ,length_in_bits=False, length=4, endian="<", format="binary", inclusive=False, signed=False, math=None, fuzzable=False, name=None):
        '''
